...
function func_caja_enlaces_descarga() {
	...
	<div id="download" class="box bxdwnl">
		<h2 class="box-title"><?php echo __( 'Download links', 'appyn' ); ?></h2>
...
function func_caja_descripcion() {
	...
	<div id="descripcion" class="box">
		<h2 class="box-title"><?php echo __( 'Description', 'appyn' ); ?></h2>
...
function func_caja_imagenes() { 
	...
	<div class="box imagenes">
		<h2 class="box-title"><?php echo __( 'Images', 'appyn' ); ?></h2>
...
function func_caja_apps_relacionadas() {
	...
	if( $query->have_posts() ) : ?>
		<div class="box rlat">
			<h2 class="box-title"><?php echo __( 'Related Apps', 'appyn' ); ?></h2>
			<div class="baps">
...
function pxdas_size() {
	...
	echo (!empty($tamano)) ? '<div class="da-s"><b>'.__( 'Size', 'appyn' ).'</b><br>'.$tamano.'</div>' : '';
}

function pxdas_version() {
    $version = get_datos_info( 'version' );

	echo (!empty($version)) ? '<div class="da-s"><b>'.__( 'Version', 'appyn' ).'</b><br>'.$version.'</div>' : ''; 
}
...
function pxdas_get_in_on() {
	...
	echo (!empty($consiguelo)) ? '<div class="da-s"><b>'.__( 'Get it on', 'appyn' ).'</b><br> <a href="'.$consiguelo.'" target="_blank">'.$imggp.'</a></div>' : ''; 
}
