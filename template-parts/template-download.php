...
<div class="container">
    <div class="pxtd">
        <a href="<?php the_permalink(); ?>" class="buttond" title="<?php echo __( 'back', 'appyn' ); ?>" style="max-width:150px; margin:0 auto 20px;"><i class="fa fa-chevron-left"></i><?php echo __( 'back', 'appyn' ); ?></a>
        <h3><?php the_title(); ?> <i class="fa fa-check-circle"></i></h3>
        <?php echo px_ads( 'ads_download_u_1' ); ?>
        <table class="table">
            <tbody>
                <tr>
                    <td><b><?php echo __( 'Package name', 'appyn' ); ?></b></td>
                    <td><?php the_title(); ?></td>
                </tr>
                <tr>
                    <td><b><?php echo __( 'Version', 'appyn' ); ?></b></td>
                    <td><?php echo get_datos_info( 'version' ); ?></td>
                </tr>
                <tr>
                    <td><b><?php echo __( 'Size', 'appyn' ); ?></b></td>
                    <td><?php echo get_datos_info( 'tamano' ); ?></td>
                </tr>
                <tr>
                    <td><b><?php echo __( 'Requirements', 'appyn' ); ?></b></td>
